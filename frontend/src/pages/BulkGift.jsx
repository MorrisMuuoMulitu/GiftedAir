...
function BulkGift() {
  ...
  const handleCheckout = async () => {
    ...
    try {
      ...
      // Use new bulk-gifts endpoint instead of payments
      const response = await fetch(`${API_URL}/api/bulk-gifts`, {
        method: 'POST',
      ...
      if (data.success && data.bulkOrderId) {
        // Redirect directly to bulk success page
    ...
    <>
      ...
      <div className="min-h-screen bg-gradient-to-br from-green-50 to-blue-50 py-12 px-4">
        <div className="container mx-auto max-w-5xl">
            ...
            <div className="flex items-center gap-4">
              {[1, 2, 3, 4].map(step => (
                <div key={step} className="flex items-center">
                  <div className={`w-10 h-10 rounded-full flex items-center justify-center font-bold ${currentStep >= step ? 'bg-forest text-white' : 'bg-gray-300 text-gray-600'
                    }`}>
                    {step}
                  </div>
          ...
          {currentStep === 1 && (
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
              ...
              <div className="grid md:grid-cols-2 gap-4 mb-8">
                {giftTypes.map(gift => (
                  <button
                    ...
                    className={`p-6 rounded-xl border-2 transition-all ${selectedType === gift.id
              ...
              <button
                ...
                className={`w-full mt-8 py-4 rounded-full font-bold text-xl ${canProceedStep1
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
              ...
              <div className="grid md:grid-cols-3 gap-4 mb-8">
                <button
                  ...
                  className={`p-6 rounded-xl border-2 ${recipientMode === 'csv' ? 'border-forest bg-green-50' : 'border-gray-200'
                    }`}
                >
                ...
                <button
                  ...
                  className={`p-6 rounded-xl border-2 ${recipientMode === 'manual' ? 'border-forest bg-green-50' : 'border-gray-200'
                    }`}
                >
                ...
                <button
                  ...
                  className={`p-6 rounded-xl border-2 ${recipientMode === 'same' ? 'border-forest bg-green-50' : 'border-gray-200'
                    }`}
                >
                  <div className="text-3xl mb-2">🔗</div>
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className={`flex-1 py-4 rounded-full font-bold text-xl ${canProceedStep2
                      ? 'bg-forest text-white hover:bg-green-800'
                      : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                    }`}
                >
            ...
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
              ...
              <div className="flex gap-4">
                ...
                <button
                  ...
                  className={`flex-1 py-4 rounded-full font-bold text-xl ${canProceedStep3
                      ? 'bg-forest text-white hover:bg-green-800'
                      : 'bg-gray-300 text-gray-500 cursor-not-allowed'
                    }`}
                >
          ...
          {currentStep === 4 && (
            <div className="bg-white rounded-2xl shadow-xl p-8 mb-8">
              <h2 className="text-3xl font-bold text-forest mb-6">Step 4: Review & Confirm</h2>
              ...
              <div className="flex gap-4">
                ...
                >
                  {isProcessing ? 'Processing...' : `Confirm Order ($${totalPrice.toFixed(2)})`}
                </button>
              </div>
            </div>
          )}
